...
```
pkgs <-  c( "arm", "boot", "car", "devtools", "Epi", "fivethirtyeight",
            "gapminder", "gt", "here", "Hmisc", "janitor", "kableExtra",
            "knitr", "magrittr", "markdown", "modelsummary", mosaic", 
            "naniar", "NHANES", "palmerpenguins", "patchwork", "psych", 
            "rmarkdown", "rms", "rstanarm", "tableone", "tidymodels", 
            "tidyverse", "visdat" )
